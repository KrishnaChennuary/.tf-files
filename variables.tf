...
variable boot_volume_image_list {
  #description = "The Image List to use for the boot volume. Defaults to Oracle Linux 7.9 UEFI_64."
  default     = "/oracle/Oracle/OL_7.9_UEFI_64"
}
